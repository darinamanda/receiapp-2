...
import id.ac.ui.cs.mobileprogramming.darinamanda.receiapp3.adapter.PagerAdapter
import id.ac.ui.cs.mobileprogramming.darinamanda.receiapp3.database.entity.RecipePhoto
import id.ac.ui.cs.mobileprogramming.darinamanda.receiapp3.viewmodel.RecipePhotoViewModel
...
import id.ac.ui.cs.mobileprogramming.darinamanda.receiapp3.MusicPlayer
...
class CookActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonStart.setOnClickListener {
            ...
            Toast.makeText(this,getString(R.string.toast_play), Toast.LENGTH_SHORT).show()
